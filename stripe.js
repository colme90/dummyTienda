...
(function() {
    ...
    if (l = "https://js.stripe.com", f = "https://js.stripe.com", g = !!/stripe\.com$/.test("undefined" != typeof window && null !== window ? window.location.host : void 0), e = "console" in window && "warn" in window.console, d = function() {
            var a;
            return (null != (a = window.performance) && "function" == typeof a.now ? a.now() : void 0) || ("function" == typeof Date.now ? Date.now() : void 0) || +new Date
        }, k = d(), i = {}, !g && "querySelectorAll" in document && e && (j = document.querySelectorAll('script[src^="' + l + '"]'), j.length || console.warn("It looks like Stripe.js is not being loaded from https://js.stripe.com. Stripe does not support serving Stripe.js from your own domain.")), a = function() {
            function a() {
            ...
            }, a._iframeBaseUrl = f, a._stripejsBaseUrl = l, a._relayResponse = function(b, c, d) {
    ...
    for (this.Stripe = a, this.Stripe.token = function() {
            ...
            return p(c, b), c.tokenName = "card", c.whitelistedAttrs = ["number", "cvc", "exp", "exp_month", "exp_year", "name", "address_line1", "address_line2", "address_city", "address_state", "address_zip", "address_country", "currency"], c.createToken = function(b, e, f) {
                var g, h, j, l;
                ...
                e[c.tokenName] = a.token.formatData(b, c.whitelistedAttrs), e.time_on_page = Math.round(d() - k);
                try {
                    l = Object.keys(i), l.length > 0 && (e.pasted_fields = l.sort().join(","))
                } catch (m) {
                    h = m
                }
                if (null == e.guid && (e.guid = "EMPTY"), null == e.muid && (e.muid = "EMPTY"), null == e.sid && (e.sid = "EMPTY"), true) try {
                    "EMPTY" === e.guid && (e.guid = a.utils.getStripeID()), "EMPTY" === e.muid && (e.muid = a.utils.getMerchantID()), "EMPTY" === e.sid && (e.sid = a.utils.getSessionID())
                } catch (m) {
                    j = m, a.reportError("DeviceIdError-Extraction")
                }
            ...
            return p(c, b), c.tokenName = "bank_account", c.whitelistedAttrs = ["country", "currency", "routing_number", "account_number", "name", "account_holder_type", "account_holder_name"], c.createToken = function(b, d, e) {
            ...
            return p(c, b), c.tokenName = "pii", c.whitelistedAttrs = ["personal_id_number"], c.createToken = function(b, d, e) {
            ...
            return p(c, b), c._whitelistedAttrs = ["amount", "currency", "email", "description"], c.createReceiver = function(b, c) {
                var d;
            ...
            return p(c, b), c.stripeAccount = null, c.create = function(b, c) {
                var d, e;
        ...
        }(), c = ["createToken", "getToken", "cardType", "validateExpiry", "validateCVC", "validateCardNumber"], m = 0, n = c.length; m < n; m++) h = c[m], this.Stripe[h] = this.Stripe.card[h];
    if (this.Stripe.stripejs_ua = "stripe.js/604c5e8", !this.Stripe._isChannel && true) try {
        "function" == typeof window.addEventListener && window.addEventListener("message", function(b) {
            ...
            try {
                ...
                for (j in c) n = c[j], e += "" + j + "=" + encodeURIComponent(n) + "&";
                i = document.createElement("iframe"), i.src = "https://js.stripe.com/v2/m/outer.html" + e, i.style.cssText = "width: 1px !important; height: 1px !important;\nposition: fixed !important; visibility: hidden !important;\npointer-events: none !important", i.setAttribute("frameborder", "0"), i.setAttribute("allowTransparency", "true"), i.setAttribute("scrolling", "no"), i.setAttribute("tabIndex", "-1"), i.setAttribute("aria-hidden", "true"), document.body.appendChild(i), k = window.location.href, setInterval(function() {
                    var b, c, d;
                    if (b = window.location.href, b !== k) {
                        try {
                            d = JSON.stringify({
                                action: "ping",
                                sid: a.utils.getSessionID(),
                ...
                b = o, a.reportError("FailedMFrameLoad")
            }
            ...
            }, h = [], l = new Date, d = function() {
                var a;
                try {
                    return a = new Date, h.push(a - l), 10 === h.length && (m("mouse-timings-10", h), document.removeEventListener("mousemove", d)), l = a
                } catch (c) {
                    b = c
                }
        ...
        "function" == typeof document.addEventListener && document.addEventListener("paste", function(b) {
            ...
            try {
                if (c = {
                        ...
                        "postal-code": "zip",
                        zip: "zip"
                    }, d = c[b.target.autocomplete] || a.utils.typeOfString(b.clipboardData.getData("text/plain"))) return i[d] = !0
            } catch (e) {
                b = e
            }
        })
    ...
    function() {
        this.Stripe.isDoubleLoaded || ! function(a, b, c, d, e, f) {
            ...
            function q(a, b, c) {
                var d;
                for (var e in b) b.hasOwnProperty(e) && (e in a ? (d = b[e],
                    "object" == typeof d ? q(a[e], d, c) : c || (a[e] = b[e])) : a[e] = b[e]);
                return a
            }
